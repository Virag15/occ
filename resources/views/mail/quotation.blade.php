            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#ffffff;border:1px solid #e4e4e7;border-radius:8px;overflow:hidden;">
                ...
                <tr><td style="padding:28px;">
                    ...
                    <p style="margin:0 0 18px;font-size:14px;line-height:1.6;color:#374151;">
                        ...
                        <strong>{{ $q->quotation_code }}</strong>. A summary is below; the full
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td style="padding:10px 16px;color:#6b7280;border-bottom:1px solid #f1f1f1;">Quotation No.</td>
                            <td style="padding:10px 16px;text-align:right;font-weight:bold;border-bottom:1px solid #f1f1f1;">{{ $q->quotation_code }}</td>
                        </tr>
                        <tr>
                            <td style="padding:10px 16px;color:#6b7280;border-bottom:1px solid #f1f1f1;">Date</td>
                            <td style="padding:10px 16px;text-align:right;border-bottom:1px solid #f1f1f1;">{{ $q->quotation_date?->format('d M Y') }}</td>
                        </tr>
                        @if ($q->valid_until)
                            <tr>
                                <td style="padding:10px 16px;color:#6b7280;border-bottom:1px solid #f1f1f1;">Valid until</td>
                                <td style="padding:10px 16px;text-align:right;border-bottom:1px solid #f1f1f1;">{{ $q->valid_until->format('d M Y') }}</td>
                            </tr>
                        @endif
                        <tr>
                    ...
                    <p style="margin:20px 0 0;font-size:13px;line-height:1.6;color:#6b7280;">
                        This is a quotation, not a tax invoice. Prices are valid till the date shown above.
